            ...
            <Row>
              <Col lg={4}>
                <div className="footer-info mt-4">
                  ...
                  <p className="text-muted mt-4 mb-2">Let’s connect on different Social Media! We post a lot about content tips tricks to help save time with your business legal and taxation related works so that you can manage grow your business. Feel free to follow us there.</p>
