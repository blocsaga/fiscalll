            ...
            <Row>
              <Col lg="12">
                <div className="title-box text-center">
                  <h3 className="title-heading mt-4">Meet the People behind Fiscall</h3>
            ...
            <Row className="justify-content-center">
              <Col lg={9}>
                <div className="text-center">
                  <h2>Get Started With <span className="text-primary">Fiscall</span></h2>
                  ...
                  <div className="mt-4 pt-2">
                    <Link to="#" className="btn btn-soft-primary btn-round mr-3 btn-rounded">Request a service</Link>
